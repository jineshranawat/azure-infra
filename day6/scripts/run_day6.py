...
def _print_databricks_steps(cfg) -> None:
    ...
    print("          (Each notebook is self-contained — no shared imports.)")
    print()
    ...
    print()
    print("4. Prerequisite: session-3\\orchestrate.cmd --setup-secrets (scope finledger).")
    print("   Notebooks load storage-account + storage-key from secrets in cell 1.")
    print()
