#!/usr/bin/env python3
"""Build + import system tables master notebook.
...
BUILD = REPO_ROOT / "day9" / "scripts" / "build_system_tables_notebook.py"
NOTEBOOK_SRC = REPO_ROOT / "day9" / "notebooks" / "nb_system_tables_master.py"
NOTEBOOK_PATH = "/Shared/day9/system_tables_master"
...
def main() -> int:
    ...
    print()
    print("=" * 70)
    print("SYSTEM TABLES MASTER LAB DEPLOYED")
    print("=" * 70)
